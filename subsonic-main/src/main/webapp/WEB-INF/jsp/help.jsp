...
<table width="75%" class="ruleTable indent">
    ...
    <tr><td class="ruleTableHeader"><fmt:message key="help.homepage.title"/></td><td class="ruleTableCell"><a target="_blank" href="http://www.subsonic.org/">Upstream project</a>, <a target="_blank" href="https://madeitwor.se/subsonic/">Unofficial(KANG) distribution</a></td></tr>
    <tr><td class="ruleTableHeader"><fmt:message key="help.forum.title"/></td><td class="ruleTableCell"><a target="_blank" href="http://forum.subsonic.org/">Upstream project</a></td></tr>
