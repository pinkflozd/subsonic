...
(function () {
    ...
    CastPlayer.prototype.initializeLocalPlayer = function () {
        ...
        this.localPlayer.setup({
            ...
            sources: [{
                file: "stream?id=${model.video.id}&player=${model.player.id}&auth=${model.video.hash}&format=raw&converted=${model.converted}",
                type: "${model.converted ? "mp4" : model.video.format}"
            }],
            tracks: tracks
        });
